...
\begin{figure}[ht]
  ...
  % nicht überschreiten.
  %
  % ACHTUNG: Zwischen den zwei folgenden \includegraphics-Befehlen
  %          darf KEINE Leerzeile stehen - ansonsten erscheinen
  %          die Figuren untereinander anstatt nebeneinander!
...
\begin{figure}[ht]
  \centering
  % Hier sorgt die Leerzeile nach dem zweiten \includegraphics-Befehl
  % dafür, dass das zweite Paar an Figuren unter dem ersten gesetzt
  % wird.
